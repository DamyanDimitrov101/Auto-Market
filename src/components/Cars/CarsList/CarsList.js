          ...
          <ul className="CarsList-list">
            <div className="CarsList-list-header">
              ...
              {this.props.showSort ?
                ...
                <article className="sort">Sort by price:
                    <span className={this.props.greenAsc ? "sort-Asc" : "sort-deactive"}
                    onClick={this.props.sortByPriceAsc.bind(this)}>Asc </span>
                      /
                    <span className={this.props.greenDesc ? "sort-Desc" : "sort-deactive"} onClick={this.props.sortByPriceDesc.bind(this)}>  Desc</span>
                </article>
