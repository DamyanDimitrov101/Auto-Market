...
function CreateNewCar({location, history}) {
    ...
    return (
        <>
          <Notification type={typeNotification} setStateNotification={setStateNotification} state={stateNotification} message={messageNotification} />
            ...
            <main className="CreateNewCar-wrapper">
                ...
                <div className="CreateNewCar">
                    <section className="CreateNewCar-imageUpload-Image-wrapper">
                        ...
                        <img src={url || picHolder} alt="Please provide photo
